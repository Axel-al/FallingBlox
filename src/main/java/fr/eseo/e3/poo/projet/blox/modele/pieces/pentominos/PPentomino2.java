...
public class PPentomino2 extends Pentomino {
    public PPentomino2(Coordonnees coordonnees, Couleur couleur) {
    ...
    protected void setElements(Coordonnees coordonnees, Couleur couleur) {
        ...
        this.elements[3] = new Element(new Coordonnees(abscisse - 1, ordonnee - 1), couleur);
